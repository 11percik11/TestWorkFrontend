...
export const Update = ({ isVisible, onClose, data }: UpdateProps) => {
  if (!isVisible) return null
  const [updateProductwww] = useUpdateUserMutation()
  ...
  const handleUpdate = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await updateProductwww({ id: data.id, userData: formData }).unwrap()
  ...
  return (
    <div className={styles.update}>
      <div className={styles.updateContent}>
        <div className={styles.update_svg} onClick={onClose}>
          <svg
